...
import lulu1 from "@assets/lululune个人账号数据1_1777460744282.jpg";
import lulu2 from "@assets/lululune个人账号数据2_1777460744282.jpg";
import lulu3 from "@assets/lululune个人账号数据3_1777460744282.jpg";
import lulu4 from "@assets/lululune个人账号数据4_1777460744285.jpg";
import lulu5 from "@assets/lululune个人账号数据5_1777460744285.jpg";
import lulu6 from "@assets/lululune个人账号数据6_1777460744285.jpg";
import lulu7 from "@assets/lululune个人账号数据7_1777460744282.jpg";
import lulu8 from "@assets/lululune个人账号数据8_1777460744284.jpg";
...
export const heroSubTagline =
  "从千人级演出到高端酒旅，懂品牌调性，更能驱动商业变现与百万级 GMV 增长。";
...
export const coreSectors: CoreSector[] = [
  ...
  },
  {
    ...
    icon: "TrendingUp",
    title: "直播电商增长体系",
    caption: "直播带货策略：选品、定价、逼单话术、限时优惠、私域导流，单场ROI 1:10，累计GMV破百万。",
    metric: "ROI 1:10",
    story:
      "以 3 万元成本撬动 30 万 GMV，ROI 1:10。从选品定价、逼单话术、限时优惠到私域导流，全程统筹并沉淀为可复用直播 SOP，赋能团队规模化复制至百万级 GMV。",
  },
  {
    id: "sector-ai",
    icon: "Sparkles",
...
export const careerJourney: CareerNode[] = [
  {
    ...
    highlights: [
      ...
      "私域生态与新媒体矩阵搭建：统筹品牌抖音及小红书账号，实现主号粉丝 11w 至 13w 跃升及新账号 0-1 突破；打通小红书票务直销通道，构建企微社群体系，通过精细化运营实现高效转化",
    ],
  },
  {
    id: "career-2",
    ...
    highlights: [
      ...
      "建立AI辅助内容生产体系：使用Midjourney/ChatGPT批量生成活动效果图，将创意设计周期缩短40%",
...
export const featuredProjects: ProjectCase[] = [
  {
    ...
    star: {
      ...
      r: "单条视频播放量百万级，登上小红书/抖音本地热榜；后续场次门票售罄，整体上座率提升 20%，极大丰富了剧场周边二次消费的场景；沉淀出「预埋热点-现场引爆-剪辑分发」的事件营销 SOP，被公司复用至多个项目。",
    },
  },
  {
    id: "case-2",
    ...
    battles: [
      {
        ...
        star: {
          ...
          r: "实现多方战略合作意向达成；现场打通「看演出 + 走空间 + 谈合作」的复合体验；发布会本身成为常营空间对外传播的内容素材，被多家文化媒体报道；建立「多业态空间发布会」操盘模板。",
        },
      },
      {
        date: "2024.5 · 五棵松",
        ...
        star: {
          ...
          r: "发布会顺利落地；30+ 媒体集中报道，包括主流文化与城市生活类媒体；交响乐团演出片段成为传播素材，建立五棵松空间的高端品牌心智，为后续档期奠定客户与媒体基础。",
        },
      },
    ],
    star: {
  ...
  },
  {
    ...
    image: project15CitiesMap,
    detailImages: [project15Cities, project15CitiesDetail],
    star: {
  ...
  },
  {
    ...
    keyData: "筹备效率 +30% | 新人上手 3 天 | 体系复用至多门店",
    intro:
      "阿那亚酒管希望根据品牌定位打造差异化的酒店体验，但各地门店（三亚、北戴河、金山岭、莫村）活动标准不一，执行质量参差不齐，缺乏可复用的方法。",
    role: "活动主管 / 产品化运营。负责从0到1设计并落地酒店在地文化体验活动体系，搭建总部级赋能中台。",
    image: projectMountainTea,
    detailImages: [projectMountainTea2],
    star: {
      s: "阿那亚酒店（三亚、北戴河、金山岭等目的地）需要打造具有在地文化特色的体验活动，但各地门店活动标准不一，执行质量参差不齐，缺乏可复用的方法。",
      t: "将黎锦文化、日落仪式等概念拆解为可复制的 SOP；整合在地资源形成供应商矩阵，搭建总部级活动资源智库，并制定极端天气应急预案，全面提升跨地域筹备效率与体验下限。",
      a: "① 体验模块标准化：将「徒步溯溪」、「日出茶席」、「手作工坊」等概念拆解为标准化体验模块（含主题文案、物料清单、动线图、执行 checklist、应急预案）。② 构建总部资源与对标智库：定期调研并解构行业标杆酒店的在地体验案例，提炼优质活动模型；搭建跨区域共享的飞书全局素材库与《活动执行手册》（涵盖话术、音乐歌单、模板），供各门店直接调用。③ AI 提效：使用 Midjourney 批量生成活动效果图，以 ChatGPT 产出文案与朋友圈宣传语，将创意设计周期缩短 40%。④ 多门店协同：通过飞书任务追踪表和多门店周会，确保进度对齐与突发快速响应；制定极端天气应急预案，覆盖全部目的地门店。",
      r: "活动筹备效率提升 30%，新人上手时间缩短至 3 天；该标准体系与资源库已被成功复用至多个门店。资源库累计收录 30+ 对标活动案例，成为总部及门店的日常策划参考工具。",
    },
  },
];
...
export const socialOps: SocialOpsBlock[] = [
  {
    ...
    account: "KOL 种草与销售矩阵",
    description:
      "拥有 100+ 达人资源库。从内容筛选、共创到转化追踪，建立精细化种草 SOP，赋能品牌实现从曝光到销售的完整闭环。",
    tags: ["达人资源库", "合作SOP", "内容种草", "数据回收"],
    stats: [
  ...
  {
    id: "social-2",
    category: "工作号 · 零预算冷启动杠杆",
    account: "@Lululune",
    description:
      "不仅用于承接品牌首发与二次分发，更将其作为社交名片。通过网感内容主动建联优质达人，搭建早期内容阵地，拓展商务长期合作网络，用创新思维打破资源壁垒。",
    tags: ["爆款策划", "首发阵地", "二次分发", "社群引流"],
    screenshotSlots: 8,
    screenshots: [lulu1, lulu2, lulu3, lulu4, lulu5, lulu6, lulu7, lulu8],
  },
  {
    id: "social-3",
    category: "个人号 · 新消费趋势与共情洞察",
    account: "@Lune 漫游手册",
    description:
      "真实视角的在地生活体验官。持续追踪新消费品牌与空间美学，凭借高敏锐度的情绪捕捉力，成功打造单篇 3.1w 赞、800w+ 浏览爆款，为品牌孵化积累极佳的 C 端体感。",
