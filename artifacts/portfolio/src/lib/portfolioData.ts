...
export const careerJourney: CareerNode[] = [
  {
    ...
    role: "营销部项目经理",
    highlights: [
      "从0到1搭建音乐IP jjapa & friends，0预算冷启动，首场售罄，3个月10+场，最高150%上座率",
      "搭建直播电商体系，3万成本撬动30万GMV，ROI 1:10",
      "小红书达人体系，年合作达人100+，百万级曝光与转化"
    ]
  },
  {
    id: "career-2",
    ...
    role: "活动主管",
    highlights: [
      "建立活动内容SOP及物料清单，筹备效率+30%",
      "用 Midjourney/ChatGPT 将创意产出周期缩短40%",
      "设计『私人定制旅行Agent』方案框架"
    ]
  },
  {
...
export const skillClusters: SkillCluster[] = [
  {
    ...
    label: "AI 营销工具",
    children: [
      { id: "ai-1", label: "Midjourney", detail: "视觉提效3倍" },
      { id: "ai-2", label: "ChatGPT & DeepSeek", detail: "文案脚本" },
      { id: "ai-3", label: "AI 考试 Agent", detail: "评茶员题库" },
      { id: "ai-4", label: "旅行 Agent 设计", detail: "私人定制旅行 Agent 方案" }
    ]
  },
  {
    id: "marketing",
  ...
  },
  {
    ...
    label: "产品化运营 SOP",
    children: [
      { id: "sop-1", label: "活动 SOP 制定", detail: "" },
      { id: "sop-2", label: "跨地域远程协同", detail: "15城巡演" },
      { id: "sop-3", label: "物料清单标准化", detail: "" }
    ]
  },
  {
    id: "data",
    ...
    children: [
      ...
      { id: "data-2", label: "活动数据看板", detail: "" },
      { id: "data-3", label: "A/B 测试", detail: "" }
    ]
  }
];
...
export const featuredProjects: ProjectCase[] = [
  {
    ...
    star: {
      ...
      a: "① 监测到抖音热点\"刀马舞\"播放量激增，主动策划\"返场舞\"作为传播引爆点。② 整理抖音数据趋势，说服舞团在常规演出后加演5分钟\"返场舞\"并融入互动动作。③ 准备 A/B/C 三套传播物料；以个人专业小红书账号为首发阵地发布剧透短视频；同步联动 3-5 个本地生活方式素人账号制造\"稀缺感\"。④ 演出当天返场环节录制高清视频，结束后 1 小时内剪出 15 秒精华版通过种子账号二次分发。",
  ...
  },
  {
    ...
    tags: ["AI Agent", "知识转化", "0代码开发"],
    keyData: "学习效率 提升3倍 | 可迁移至企业培训",
